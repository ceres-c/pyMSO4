...
\begin{figure}[htbp]
	...
	\begin{minipage}{.5\textwidth}
	  \centering
	  \includegraphics[trim=50 0 50 0,clip,width=.9\linewidth]{../examples/img/ex0_setup.jpg}
	  \captionof{figure}{Square wave setup}
	  \label{fig:square-wave-setup}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
	  \centering
	  \includegraphics[trim=0 700 0 0,clip,width=.9\linewidth]{../docs/_static/cw305_connection.jpg}
